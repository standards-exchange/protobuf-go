...
func (x *RT000FTL8_SecurityPricingError) GetEffectiveDate() string {
	if x != nil {
		return x.EffectiveDate
	}
	return ""
...
type RT000FTL8_StockBreak struct {
	...
	ProducerIdentifierDescription string `protobuf:"bytes,62,opt,name=producer_identifier_description,json=producerIdentifierDescription,proto3" json:"producer_identifier_description,omitempty"`
	// The asset class of the security
...
func (x *RT000FTL8_StockBreak) GetProducerIdentifierDescription() string {
	if x != nil {
		return x.ProducerIdentifierDescription
	}
	return ""
}
...
func (x *RT000FTL8_CashBreak) GetEffectiveDate() string {
	if x != nil {
		return x.EffectiveDate
	}
	return ""
...
func (x *RT000FTL8_TotalExpenseRatio) GetEffectiveDate() string {
	if x != nil {
		return x.EffectiveDate
	}
	return ""
...
type RT000FTL8_Invoice struct {
	...
	// For example, "2023-05-24" is a valid value.
	// All values should strictly adhere to this pattern.
	InvoiceDate string `protobuf:"bytes,1,opt,name=invoice_date,json=invoiceDate,proto3" json:"invoice_date,omitempty"`
	...
	// For example, "2023-05-24" is a valid value.
	// All values should strictly adhere to this pattern.
	AuthorisationDate string `protobuf:"bytes,2,opt,name=authorisation_date,json=authorisationDate,proto3" json:"authorisation_date,omitempty"`
	// The date of payment
	// The field represents a date in ISO 8601 format "YYYY-MM-DD".
	// "YYYY" represents a four-digit year, "MM" a two-digit month (01 through 12),
	// and "DD" a two-digit day (01 through 31).
	...
	// The invoiced amount
	InvoicedAmount float64 `protobuf:"fixed64,7,opt,name=invoiced_amount,json=invoicedAmount,proto3" json:"invoiced_amount,omitempty"`
	// The invoiced amount specific to the fund in question
	FundSpecificAmount float64 `protobuf:"fixed64,8,opt,name=fund_specific_amount,json=fundSpecificAmount,proto3" json:"fund_specific_amount,omitempty"`
}
...
type RT000FTL8_SwingPricingEvent struct {
	...
	SwingThreshold float64 `protobuf:"fixed64,2,opt,name=swing_threshold,json=swingThreshold,proto3" json:"swing_threshold,omitempty"`
	...
	NavWithoutSwingFactor float64 `protobuf:"fixed64,4,opt,name=nav_without_swing_factor,json=navWithoutSwingFactor,proto3" json:"nav_without_swing_factor,omitempty"`
	// The NAV after the swing factor had been applied
	NavWithSwingFactor float64 `protobuf:"fixed64,5,opt,name=nav_with_swing_factor,json=navWithSwingFactor,proto3" json:"nav_with_swing_factor,omitempty"`
}
...
func (x *RT000FTL8_SwingPricingEvent) GetEffectiveDate() string {
	if x != nil {
		return x.EffectiveDate
	}
	return ""
...
type RT000FTL8_PerShareClassNAV struct {
	...
	NavPerUnitBaseCurrency float64 `protobuf:"fixed64,6,opt,name=nav_per_unit_base_currency,json=navPerUnitBaseCurrency,proto3" json:"nav_per_unit_base_currency,omitempty"`
	// The current total nav of the share class in the base currency
	TotalNavBaseCurrency float64 `protobuf:"fixed64,7,opt,name=total_nav_base_currency,json=totalNavBaseCurrency,proto3" json:"total_nav_base_currency,omitempty"`
	// The nav per unit in the reporting currency at at the effective_date
	NavPerUnitReportingCurrency float64 `protobuf:"fixed64,8,opt,name=nav_per_unit_reporting_currency,json=navPerUnitReportingCurrency,proto3" json:"nav_per_unit_reporting_currency,omitempty"`
	// The current total nav of the share class in the reporting currency
	TotalNavReportingCurrency float64 `protobuf:"fixed64,9,opt,name=total_nav_reporting_currency,json=totalNavReportingCurrency,proto3" json:"total_nav_reporting_currency,omitempty"`
}
...
func (x *RT000FTL8_PerShareClassNAV) GetEffectiveDate() string {
	if x != nil {
		return x.EffectiveDate
	}
	return ""
...
var file_standards_open_v1_RT000FTL8_proto_rawDesc = []byte{
	...
	0x6e, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x61, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdd,
	0x45, 0x0a, 0x09, 0x52, 0x54, 0x30, 0x30, 0x30, 0x46, 0x54, 0x4c, 0x38, 0x12, 0x47, 0x0a, 0x07,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x65, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x63, 0x61, 0x73, 0x65, 0x49,
	...
	0x12, 0x80, 0x01, 0x0a, 0x17, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x5f, 0x69, 0x64, 0x65,
	...
	0x2e, 0x53, 0x74, 0x61, 0x6c, 0x65, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x2e, 0x46,
	...
	,
	...
	,
	...
	,
	...
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0xb9, 0x01, 0x0a, 0x0a, 0x41, 0x73, 0x73, 0x65, 0x74, 0x43,
	...
	,
	...
	0x04, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0b, 0x6d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x69,
	0x74, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x61, 0x75, 0x73, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x63, 0x61, 0x75, 0x73, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x72, 0x65, 0x6d, 0x65,
	0x64, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x72,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x46, 0x49, 0x47, 0x49, 0x10,
	0x01, 0x12, 0x0b, 0x0a, 0x07, 0x50, 0x45, 0x52, 0x4d, 0x5f, 0x49, 0x44, 0x10, 0x02, 0x22, 0x4b,
...
var file_standards_open_v1_RT000FTL8_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
...
var file_standards_open_v1_RT000FTL8_proto_goTypes = []interface{}{
	...
	(RT000FTL8_StaleSecurity_FinancialInstrumentIdentifier)(0),        // 3: standards.open.v1.RT000FTL8.StaleSecurity.FinancialInstrumentIdentifier
	(RT000FTL8_StaleSecurity_AssetClass)(0),                           // 4: standards.open.v1.RT000FTL8.StaleSecurity.AssetClass
	(RT000FTL8_StockBreak_AssetClass)(0),                              // 5: standards.open.v1.RT000FTL8.StockBreak.AssetClass
	(RT000FTL8_TotalExpenseRatio_ShareClassIdentifierTypes)(0),        // 6: standards.open.v1.RT000FTL8.TotalExpenseRatio.ShareClassIdentifierTypes
	(RT000FTL8_PerShareClassNAV_FinancialInstrumentIdentifier)(0),     // 7: standards.open.v1.RT000FTL8.PerShareClassNAV.FinancialInstrumentIdentifier
	(*RT000FTL8)(nil),                                // 8: standards.open.v1.RT000FTL8
	(*RT000FTL8Batch)(nil),                           // 9: standards.open.v1.RT000FTL8_batch
	(*RT000FTL8_MonthlyRAGMetric)(nil),               // 10: standards.open.v1.RT000FTL8.MonthlyRAGMetric
	(*RT000FTL8_NetAssetValueSnapshot)(nil),          // 11: standards.open.v1.RT000FTL8.NetAssetValueSnapshot
	(*RT000FTL8_NAVCalculationErrorInformation)(nil), // 12: standards.open.v1.RT000FTL8.NAVCalculationErrorInformation
	(*RT000FTL8_SecurityPricingError)(nil),           // 13: standards.open.v1.RT000FTL8.SecurityPricingError
	(*RT000FTL8_StaleSecurity)(nil),                  // 14: standards.open.v1.RT000FTL8.StaleSecurity
	(*RT000FTL8_StockBreak)(nil),                     // 15: standards.open.v1.RT000FTL8.StockBreak
	(*RT000FTL8_CashBreak)(nil),                      // 16: standards.open.v1.RT000FTL8.CashBreak
	(*RT000FTL8_TotalExpenseRatio)(nil),              // 17: standards.open.v1.RT000FTL8.TotalExpenseRatio
	(*RT000FTL8_Invoice)(nil),                        // 18: standards.open.v1.RT000FTL8.Invoice
	(*RT000FTL8_SwingPricingEvent)(nil),              // 19: standards.open.v1.RT000FTL8.SwingPricingEvent
	(*RT000FTL8_PerShareClassNAV)(nil),               // 20: standards.open.v1.RT000FTL8.PerShareClassNAV
	(RedAmberGreen)(0),                               // 21: standards.open.v1.RedAmberGreen
}
var file_standards_open_v1_RT000FTL8_proto_depIdxs = []int32{
	10, // 0: standards.open.v1.RT000FTL8.metrics:type_name -> standards.open.v1.RT000FTL8.MonthlyRAGMetric
	11, // 1: standards.open.v1.RT000FTL8.net_asset_values:type_name -> standards.open.v1.RT000FTL8.NetAssetValueSnapshot
	12, // 2: standards.open.v1.RT000FTL8.nav_calculation_errors:type_name -> standards.open.v1.RT000FTL8.NAVCalculationErrorInformation
	13, // 3: standards.open.v1.RT000FTL8.security_pricing_errors:type_name -> standards.open.v1.RT000FTL8.SecurityPricingError
	14, // 4: standards.open.v1.RT000FTL8.stale_securities:type_name -> standards.open.v1.RT000FTL8.StaleSecurity
	15, // 5: standards.open.v1.RT000FTL8.stock_breaks:type_name -> standards.open.v1.RT000FTL8.StockBreak
	16, // 6: standards.open.v1.RT000FTL8.cash_breaks:type_name -> standards.open.v1.RT000FTL8.CashBreak
	17, // 7: standards.open.v1.RT000FTL8.total_expense_ratios:type_name -> standards.open.v1.RT000FTL8.TotalExpenseRatio
	18, // 8: standards.open.v1.RT000FTL8.recent_invoices:type_name -> standards.open.v1.RT000FTL8.Invoice
	19, // 9: standards.open.v1.RT000FTL8.swing_pricing_events:type_name -> standards.open.v1.RT000FTL8.SwingPricingEvent
	20, // 10: standards.open.v1.RT000FTL8.per_share_class_nav_historical:type_name -> standards.open.v1.RT000FTL8.PerShareClassNAV
	8,  // 11: standards.open.v1.RT000FTL8_batch.response:type_name -> standards.open.v1.RT000FTL8
	...
	21, // 14: standards.open.v1.RT000FTL8.MonthlyRAGMetric.rag:type_name -> standards.open.v1.RedAmberGreen
	2,  // 15: standards.open.v1.RT000FTL8.SecurityPricingError.financial_identifier:type_name -> standards.open.v1.RT000FTL8.SecurityPricingError.FinancialInstrumentIdentifier
	3,  // 16: standards.open.v1.RT000FTL8.StaleSecurity.primary_identifier_type:type_name -> standards.open.v1.RT000FTL8.StaleSecurity.FinancialInstrumentIdentifier
	4,  // 17: standards.open.v1.RT000FTL8.StaleSecurity.asset_class:type_name -> standards.open.v1.RT000FTL8.StaleSecurity.AssetClass
	5,  // 18: standards.open.v1.RT000FTL8.StockBreak.asset_class:type_name -> standards.open.v1.RT000FTL8.StockBreak.AssetClass
	6,  // 19: standards.open.v1.RT000FTL8.TotalExpenseRatio.share_class_id_type:type_name -> standards.open.v1.RT000FTL8.TotalExpenseRatio.ShareClassIdentifierTypes
	7,  // 20: standards.open.v1.RT000FTL8.PerShareClassNAV.financial_identifier:type_name -> standards.open.v1.RT000FTL8.PerShareClassNAV.FinancialInstrumentIdentifier
