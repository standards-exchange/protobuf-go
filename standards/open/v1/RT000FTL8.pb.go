...
func (x *RT000FTL8) GetMetrics() *RT000FTL8_Metrics {
	if x != nil {
		return x.Metrics
	}
	return nil
...
func (x *RT000FTL8_Overview) GetEffectiveDate() *date.Date {
	if x != nil {
...
func (x *RT000FTL8_Overview) GetProductionDate() *date.Date {
	if x != nil {
...
func (x *RT000FTL8_Overview) GetValuationDate() *date.Date {
	if x != nil {
...
func (x *RT000FTL8_Overview) GetFund() string {
	if x != nil {
		return x.Fund
	}
	return ""
...
type RT000FTL8_Metrics struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Number of NAVs calculated during the month
	NavsCalculated []*MonthlyRAGMetric `protobuf:"bytes,1,rep,name=navs_calculated,json=navsCalculated,proto3" json:"navs_calculated,omitempty"`
	// Percentage of total NAVs delivered within the agreed timescale during the reporting month.
	PercentNavTimeliness []*MonthlyRAGMetric `protobuf:"bytes,2,rep,name=percent_nav_timeliness,json=percentNavTimeliness,proto3" json:"percent_nav_timeliness,omitempty"`
	// Percentage of total NAVs delivered within the agreed timescale during the reporting month, excluding non-provider
	// caused delays.
	PercentNavTimelinessExcludingNonProviderDelays []*MonthlyRAGMetric `protobuf:"bytes,3,rep,name=percent_nav_timeliness_excluding_non_provider_delays,json=percentNavTimelinessExcludingNonProviderDelays,proto3" json:"percent_nav_timeliness_excluding_non_provider_delays,omitempty"`
	// Total Number of Fund Accounting Delegate Delayed NAVs
	TotalFundAccountingDelayedNavs []*MonthlyRAGMetric `protobuf:"bytes,4,rep,name=total_fund_accounting_delayed_navs,json=totalFundAccountingDelayedNavs,proto3" json:"total_fund_accounting_delayed_navs,omitempty"`
	// Total Number of Non-Fund Accounting Delayed NAVs
	NonFundAccountingDelayedNavs []*MonthlyRAGMetric `protobuf:"bytes,5,rep,name=non_fund_accounting_delayed_navs,json=nonFundAccountingDelayedNavs,proto3" json:"non_fund_accounting_delayed_navs,omitempty"`
	...
	NavCalculationAccuracy []*MonthlyRAGMetric `protobuf:"bytes,6,rep,name=nav_calculation_accuracy,json=navCalculationAccuracy,proto3" json:"nav_calculation_accuracy,omitempty"`
	// Total number of valuations which were priced incorrectly over the entire error period.
	NonMaterialNavErrors []*MonthlyRAGMetric `protobuf:"bytes,7,rep,name=non_material_nav_errors,json=nonMaterialNavErrors,proto3" json:"non_material_nav_errors,omitempty"`
	// Total number of material valuations errors over the entire error period (where materiality is defined by the board).
	MaterialNavErrors []*MonthlyRAGMetric `protobuf:"bytes,8,rep,name=material_nav_errors,json=materialNavErrors,proto3" json:"material_nav_errors,omitempty"`
	// Number of cash reconciliations reported between 31 to 60 days
	CashReconciliations_31To_60Days []*MonthlyRAGMetric `protobuf:"bytes,9,rep,name=cash_reconciliations_31_to_60_days,json=cashReconciliations31To60Days,proto3" json:"cash_reconciliations_31_to_60_days,omitempty"`
	// Number of cash reconciliations reported greater than or equal to 61 days
	CashReconciliationsMoreThan_60Days []*MonthlyRAGMetric `protobuf:"bytes,10,rep,name=cash_reconciliations_more_than_60_days,json=cashReconciliationsMoreThan60Days,proto3" json:"cash_reconciliations_more_than_60_days,omitempty"`
	// Number of stock reconciliations reported between 31 to 60 days
	StockReconciliations_31To_60Days []*MonthlyRAGMetric `protobuf:"bytes,11,rep,name=stock_reconciliations_31_to_60_days,json=stockReconciliations31To60Days,proto3" json:"stock_reconciliations_31_to_60_days,omitempty"`
	// Number of stock reconciliations reported greater than or equal to 61 days
	StockReconciliationsMoreThan_60Days []*MonthlyRAGMetric `protobuf:"bytes,12,rep,name=stock_reconciliations_more_than_60_days,json=stockReconciliationsMoreThan60Days,proto3" json:"stock_reconciliations_more_than_60_days,omitempty"`
	// Number of system issues that occurred during the month.
	SystemIssues []*MonthlyRAGMetric `protobuf:"bytes,13,rep,name=system_issues,json=systemIssues,proto3" json:"system_issues,omitempty"`
}

func (x *RT000FTL8_Metrics) Reset() {
	*x = RT000FTL8_Metrics{}
	if protoimpl.UnsafeEnabled {
...
func (x *RT000FTL8_Metrics) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RT000FTL8_Metrics) ProtoMessage() {}

func (x *RT000FTL8_Metrics) ProtoReflect() protoreflect.Message {
	mi := &file_standards_open_v1_RT000FTL8_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RT000FTL8_Metrics.ProtoReflect.Descriptor instead.
func (*RT000FTL8_Metrics) Descriptor() ([]byte, []int) {
	return file_standards_open_v1_RT000FTL8_proto_rawDescGZIP(), []int{0, 1}
}

func (x *RT000FTL8_Metrics) GetNavsCalculated() []*MonthlyRAGMetric {
	if x != nil {
		return x.NavsCalculated
	}
	return nil
}

func (x *RT000FTL8_Metrics) GetPercentNavTimeliness() []*MonthlyRAGMetric {
	if x != nil {
...
func (x *RT000FTL8_Metrics) GetPercentNavTimelinessExcludingNonProviderDelays() []*MonthlyRAGMetric {
	if x != nil {
		return x.PercentNavTimelinessExcludingNonProviderDelays
	}
	return nil
}

func (x *RT000FTL8_Metrics) GetTotalFundAccountingDelayedNavs() []*MonthlyRAGMetric {
	if x != nil {
		return x.TotalFundAccountingDelayedNavs
	}
	return nil
}

func (x *RT000FTL8_Metrics) GetNonFundAccountingDelayedNavs() []*MonthlyRAGMetric {
	if x != nil {
		return x.NonFundAccountingDelayedNavs
	}
	return nil
}

func (x *RT000FTL8_Metrics) GetNavCalculationAccuracy() []*MonthlyRAGMetric {
	if x != nil {
		return x.NavCalculationAccuracy
	}
	return nil
}

func (x *RT000FTL8_Metrics) GetNonMaterialNavErrors() []*MonthlyRAGMetric {
	if x != nil {
		return x.NonMaterialNavErrors
	}
	return nil
}

func (x *RT000FTL8_Metrics) GetMaterialNavErrors() []*MonthlyRAGMetric {
	if x != nil {
		return x.MaterialNavErrors
	}
	return nil
}

func (x *RT000FTL8_Metrics) GetCashReconciliations_31To_60Days() []*MonthlyRAGMetric {
	if x != nil {
		return x.CashReconciliations_31To_60Days
	}
	return nil
}

func (x *RT000FTL8_Metrics) GetCashReconciliationsMoreThan_60Days() []*MonthlyRAGMetric {
	if x != nil {
		return x.CashReconciliationsMoreThan_60Days
	}
	return nil
}

func (x *RT000FTL8_Metrics) GetStockReconciliations_31To_60Days() []*MonthlyRAGMetric {
	if x != nil {
		return x.StockReconciliations_31To_60Days
	}
	return nil
}

func (x *RT000FTL8_Metrics) GetStockReconciliationsMoreThan_60Days() []*MonthlyRAGMetric {
	if x != nil {
		return x.StockReconciliationsMoreThan_60Days
	}
	return nil
}

func (x *RT000FTL8_Metrics) GetSystemIssues() []*MonthlyRAGMetric {
	if x != nil {
...
var file_standards_open_v1_RT000FTL8_proto_rawDesc = []byte{
	...
	0xb5, 0x3f, 0x0a, 0x09, 0x52, 0x54, 0x30, 0x30, 0x30, 0x46, 0x54, 0x4c, 0x38, 0x12, 0x41, 0x0a,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x52, 0x54, 0x30, 0x30, 0x30, 0x46, 0x54, 0x4c, 0x38, 0x2e, 0x4f, 0x76,
	...
	,
	...
	0x76, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x69, 0x63, 0x61, 0x6c, 0x1a, 0x86, 0x03, 0x0a, 0x08,
	0x4f, 0x76, 0x65, 0x72, 0x76, 0x69, 0x65, 0x77, 0x12, 0x38, 0x0a, 0x0e, 0x65, 0x66, 0x66, 0x65,
	...
	0x74, 0x65, 0x12, 0x25, 0x0a, 0x0e, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x5f,
	0x79, 0x65, 0x61, 0x72, 0x18, 0x65, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x72, 0x65, 0x70, 0x6f,
	0x72, 0x74, 0x69, 0x6e, 0x67, 0x59, 0x65, 0x61, 0x72, 0x12, 0x3b, 0x0a, 0x0f, 0x72, 0x65, 0x70,
	0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x6d, 0x6f, 0x6e, 0x74, 0x68, 0x18, 0x66, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x12, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x74, 0x79, 0x70, 0x65,
	0x2e, 0x4d, 0x6f, 0x6e, 0x74, 0x68, 0x52, 0x0e, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x69, 0x6e,
	0x67, 0x4d, 0x6f, 0x6e, 0x74, 0x68, 0x12, 0x3a, 0x0a, 0x0f, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63,
	...
	0x74, 0x65, 0x52, 0x0e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61,
	0x74, 0x65, 0x12, 0x38, 0x0a, 0x0e, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x64, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x44, 0x61, 0x74, 0x65, 0x52, 0x0d, 0x76,
	0x61, 0x6c, 0x75, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x65, 0x12, 0x23, 0x0a, 0x0d,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	0x74, 0x73, 0x1a, 0x96, 0x05, 0x0a, 0x14, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x50,
	0x72, 0x69, 0x63, 0x69, 0x6e, 0x67, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x38, 0x0a, 0x0e, 0x65,
	...
	0x18, 0x09, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x73,
	...
	0x0a, 0x07, 0x50, 0x45, 0x52, 0x4d, 0x5f, 0x49, 0x44, 0x10, 0x0a, 0x1a, 0x8b, 0x04, 0x0a, 0x0d,
	0x53, 0x74, 0x61, 0x6c, 0x65, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x12, 0x7b, 0x0a,
	0x14, 0x66, 0x69, 0x6e, 0x61, 0x6e, 0x63, 0x69, 0x61, 0x6c, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x66, 0x69, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x48, 0x2e, 0x73, 0x74,
	0x61, 0x6e, 0x64, 0x61, 0x72, 0x64, 0x73, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x2e, 0x76, 0x31, 0x2e,
	...
	,
	...
	0x50, 0x45, 0x52, 0x4d, 0x5f, 0x49, 0x44, 0x10, 0x0a, 0x1a, 0xff, 0x04, 0x0a, 0x0a, 0x53, 0x74,
	0x6f, 0x63, 0x6b, 0x42, 0x72, 0x65, 0x61, 0x6b, 0x12, 0x38, 0x0a, 0x0e, 0x65, 0x66, 0x66, 0x65,
	0x63, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x11, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x44,
	0x61, 0x74, 0x65, 0x52, 0x0d, 0x65, 0x66, 0x66, 0x65, 0x63, 0x74, 0x69, 0x76, 0x65, 0x44, 0x61,
	...
	0x74, 0x65, 0x12, 0x78, 0x0a, 0x14, 0x66, 0x69, 0x6e, 0x61, 0x6e, 0x63, 0x69, 0x61, 0x6c, 0x5f,
	...
	0x74, 0x6f, 0x63, 0x6b, 0x42, 0x72, 0x65, 0x61, 0x6b, 0x2e, 0x46, 0x69, 0x6e, 0x61, 0x6e, 0x63,
	...
	,
	...
	0x10, 0x06, 0x12, 0x07, 0x0a, 0x03, 0x52, 0x49, 0x43, 0x10, 0x07, 0x12, 0x08, 0x0a, 0x04, 0x46,
	0x49, 0x47, 0x49, 0x10, 0x08, 0x12, 0x07, 0x0a, 0x03, 0x4c, 0x45, 0x49, 0x10, 0x09, 0x12, 0x0b,
	0x0a, 0x07, 0x50, 0x45, 0x52, 0x4d, 0x5f, 0x49, 0x44, 0x10, 0x0a, 0x1a, 0xb9, 0x02, 0x0a, 0x09,
	...
	0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07,
	...
	0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x09,
	...
	0x0a, 0x1a, 0xa2, 0x03, 0x0a, 0x07, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x12, 0x34, 0x0a,
	...
	0x79, 0x70, 0x65, 0x12, 0x3b, 0x0a, 0x0f, 0x69, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x64, 0x5f,
	...
	0x52, 0x0e, 0x69, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x64, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74,
	0x12, 0x44, 0x0a, 0x14, 0x66, 0x75, 0x6e, 0x64, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69,
	0x63, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x4d, 0x6f, 0x6e,
	0x65, 0x79, 0x52, 0x12, 0x66, 0x75, 0x6e, 0x64, 0x53, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x63,
	0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x1a, 0xc1, 0x02, 0x0a, 0x11, 0x53, 0x77, 0x69, 0x6e, 0x67,
	...
	0x76, 0x65, 0x44, 0x61, 0x74, 0x65, 0x12, 0x3b, 0x0a, 0x0f, 0x73, 0x77, 0x69, 0x6e, 0x67, 0x5f,
	...
	0x6e, 0x65, 0x79, 0x52, 0x0e, 0x73, 0x77, 0x69, 0x6e, 0x67, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68,
	0x6f, 0x6c, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x77, 0x69, 0x6e, 0x67, 0x5f, 0x66, 0x61, 0x63,
	0x74, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0b, 0x73, 0x77, 0x69, 0x6e, 0x67,
	0x46, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x4b, 0x0a, 0x18, 0x6e, 0x61, 0x76, 0x5f, 0x77, 0x69,
	...
	,
	...
	0x63, 0x74, 0x69, 0x76, 0x65, 0x44, 0x61, 0x74, 0x65, 0x12, 0x7e, 0x0a, 0x14, 0x66, 0x69, 0x6e,
	0x61, 0x6e, 0x63, 0x69, 0x61, 0x6c, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65,
	0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x4b, 0x2e, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x61,
	...
	0x61, 0x73, 0x73, 0x4e, 0x41, 0x56, 0x2e, 0x46, 0x69, 0x6e, 0x61, 0x6e, 0x63, 0x69, 0x61, 0x6c,
	...
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x24, 0x0a, 0x0e, 0x73, 0x68, 0x61,
	...
	,
	...
	0x65, 0x6e, 0x63, 0x79, 0x12, 0x58, 0x0a, 0x1f, 0x6e, 0x61, 0x76, 0x5f, 0x70, 0x65, 0x72, 0x5f,
	0x75, 0x6e, 0x69, 0x74, 0x5f, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x63,
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x4d, 0x6f, 0x6e, 0x65,
	0x79, 0x52, 0x1b, 0x6e, 0x61, 0x76, 0x50, 0x65, 0x72, 0x55, 0x6e, 0x69, 0x74, 0x52, 0x65, 0x70,
	0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x53,
	...
	0x70, 0x65, 0x2e, 0x4d, 0x6f, 0x6e, 0x65, 0x79, 0x52, 0x19, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x4e,
	0x61, 0x76, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x43, 0x75, 0x72, 0x72, 0x65,
	0x6e, 0x63, 0x79, 0x22, 0x52, 0x0a, 0x1d, 0x46, 0x69, 0x6e, 0x61, 0x6e, 0x63, 0x69, 0x61, 0x6c,
	0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69,
	...
	0x52, 0x4d, 0x5f, 0x49, 0x44, 0x10, 0x02, 0x22, 0x4b, 0x0a, 0x0f, 0x52, 0x54, 0x30, 0x30, 0x30,
...
var file_standards_open_v1_RT000FTL8_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_standards_open_v1_RT000FTL8_proto_goTypes = []interface{}{
	...
	(*RT000FTL8_Overview)(nil),                       // 7: standards.open.v1.RT000FTL8.Overview
	(*RT000FTL8_Metrics)(nil),                        // 8: standards.open.v1.RT000FTL8.Metrics
	(*RT000FTL8_AssetsUnderManagement)(nil),          // 9: standards.open.v1.RT000FTL8.AssetsUnderManagement
	(*RT000FTL8_NAVCalculationErrorInformation)(nil), // 10: standards.open.v1.RT000FTL8.NAVCalculationErrorInformation
	(*RT000FTL8_SecurityPricingError)(nil),           // 11: standards.open.v1.RT000FTL8.SecurityPricingError
	(*RT000FTL8_StaleSecurity)(nil),                  // 12: standards.open.v1.RT000FTL8.StaleSecurity
	(*RT000FTL8_StockBreak)(nil),                     // 13: standards.open.v1.RT000FTL8.StockBreak
	(*RT000FTL8_CashBreak)(nil),                      // 14: standards.open.v1.RT000FTL8.CashBreak
	(*RT000FTL8_TotalExpenseRatio)(nil),              // 15: standards.open.v1.RT000FTL8.TotalExpenseRatio
	(*RT000FTL8_Invoice)(nil),                        // 16: standards.open.v1.RT000FTL8.Invoice
	(*RT000FTL8_SwingPricingEvent)(nil),              // 17: standards.open.v1.RT000FTL8.SwingPricingEvent
	(*RT000FTL8_PerShareClassNAV)(nil),               // 18: standards.open.v1.RT000FTL8.PerShareClassNAV
	(*date.Date)(nil),                                // 19: google.type.Date
	(month.Month)(0),                                 // 20: google.type.Month
	(*MonthlyRAGMetric)(nil),                         // 21: standards.open.v1.MonthlyRAGMetric
	(*money.Money)(nil),                              // 22: google.type.Money
}
var file_standards_open_v1_RT000FTL8_proto_depIdxs = []int32{
	7,  // 0: standards.open.v1.RT000FTL8.overview:type_name -> standards.open.v1.RT000FTL8.Overview
	8,  // 1: standards.open.v1.RT000FTL8.metrics:type_name -> standards.open.v1.RT000FTL8.Metrics
	9,  // 2: standards.open.v1.RT000FTL8.assets_under_management_monthly:type_name -> standards.open.v1.RT000FTL8.AssetsUnderManagement
	10, // 3: standards.open.v1.RT000FTL8.nav_calculation_errors:type_name -> standards.open.v1.RT000FTL8.NAVCalculationErrorInformation
	11, // 4: standards.open.v1.RT000FTL8.security_pricing_errors:type_name -> standards.open.v1.RT000FTL8.SecurityPricingError
	12, // 5: standards.open.v1.RT000FTL8.stale_securities:type_name -> standards.open.v1.RT000FTL8.StaleSecurity
	13, // 6: standards.open.v1.RT000FTL8.stock_breaks:type_name -> standards.open.v1.RT000FTL8.StockBreak
	14, // 7: standards.open.v1.RT000FTL8.cash_breaks:type_name -> standards.open.v1.RT000FTL8.CashBreak
	15, // 8: standards.open.v1.RT000FTL8.total_expense_ratios:type_name -> standards.open.v1.RT000FTL8.TotalExpenseRatio
	16, // 9: standards.open.v1.RT000FTL8.recent_invoices:type_name -> standards.open.v1.RT000FTL8.Invoice
	17, // 10: standards.open.v1.RT000FTL8.swing_pricing_events:type_name -> standards.open.v1.RT000FTL8.SwingPricingEvent
	18, // 11: standards.open.v1.RT000FTL8.per_share_class_nav_historical:type_name -> standards.open.v1.RT000FTL8.PerShareClassNAV
	5,  // 12: standards.open.v1.RT000FTL8_batch.response:type_name -> standards.open.v1.RT000FTL8
	19, // 13: standards.open.v1.RT000FTL8.Overview.effective_date:type_name -> google.type.Date
	20, // 14: standards.open.v1.RT000FTL8.Overview.reporting_month:type_name -> google.type.Month
	19, // 15: standards.open.v1.RT000FTL8.Overview.production_date:type_name -> google.type.Date
	19, // 16: standards.open.v1.RT000FTL8.Overview.valuation_date:type_name -> google.type.Date
	21, // 17: standards.open.v1.RT000FTL8.Metrics.navs_calculated:type_name -> standards.open.v1.MonthlyRAGMetric
	21, // 18: standards.open.v1.RT000FTL8.Metrics.percent_nav_timeliness:type_name -> standards.open.v1.MonthlyRAGMetric
	21, // 19: standards.open.v1.RT000FTL8.Metrics.percent_nav_timeliness_excluding_non_provider_delays:type_name -> standards.open.v1.MonthlyRAGMetric
	21, // 20: standards.open.v1.RT000FTL8.Metrics.total_fund_accounting_delayed_navs:type_name -> standards.open.v1.MonthlyRAGMetric
	21, // 21: standards.open.v1.RT000FTL8.Metrics.non_fund_accounting_delayed_navs:type_name -> standards.open.v1.MonthlyRAGMetric
	21, // 22: standards.open.v1.RT000FTL8.Metrics.nav_calculation_accuracy:type_name -> standards.open.v1.MonthlyRAGMetric
	21, // 23: standards.open.v1.RT000FTL8.Metrics.non_material_nav_errors:type_name -> standards.open.v1.MonthlyRAGMetric
	21, // 24: standards.open.v1.RT000FTL8.Metrics.material_nav_errors:type_name -> standards.open.v1.MonthlyRAGMetric
	21, // 25: standards.open.v1.RT000FTL8.Metrics.cash_reconciliations_31_to_60_days:type_name -> standards.open.v1.MonthlyRAGMetric
	21, // 26: standards.open.v1.RT000FTL8.Metrics.cash_reconciliations_more_than_60_days:type_name -> standards.open.v1.MonthlyRAGMetric
	21, // 27: standards.open.v1.RT000FTL8.Metrics.stock_reconciliations_31_to_60_days:type_name -> standards.open.v1.MonthlyRAGMetric
	21, // 28: standards.open.v1.RT000FTL8.Metrics.stock_reconciliations_more_than_60_days:type_name -> standards.open.v1.MonthlyRAGMetric
	21, // 29: standards.open.v1.RT000FTL8.Metrics.system_issues:type_name -> standards.open.v1.MonthlyRAGMetric
	19, // 30: standards.open.v1.RT000FTL8.AssetsUnderManagement.effective_date:type_name -> google.type.Date
	22, // 31: standards.open.v1.RT000FTL8.AssetsUnderManagement.aum_base_currency:type_name -> google.type.Money
	22, // 32: standards.open.v1.RT000FTL8.AssetsUnderManagement.aum_reporting_currency:type_name -> google.type.Money
	22, // 33: standards.open.v1.RT000FTL8.AssetsUnderManagement.monthly_change_aum_base_currency:type_name -> google.type.Money
	22, // 34: standards.open.v1.RT000FTL8.AssetsUnderManagement.monthly_change_aum_reporting_currency:type_name -> google.type.Money
	22, // 35: standards.open.v1.RT000FTL8.AssetsUnderManagement.quarterly_change_aum_base_currency:type_name -> google.type.Money
	22, // 36: standards.open.v1.RT000FTL8.AssetsUnderManagement.quarterly_change_aum_reporting_currency:type_name -> google.type.Money
	19, // 37: standards.open.v1.RT000FTL8.NAVCalculationErrorInformation.effective_date:type_name -> google.type.Date
	19, // 38: standards.open.v1.RT000FTL8.NAVCalculationErrorInformation.identification_date:type_name -> google.type.Date
	19, // 39: standards.open.v1.RT000FTL8.NAVCalculationErrorInformation.resolution_date:type_name -> google.type.Date
	19, // 40: standards.open.v1.RT000FTL8.SecurityPricingError.effective_date:type_name -> google.type.Date
	19, // 41: standards.open.v1.RT000FTL8.SecurityPricingError.identification_date:type_name -> google.type.Date
	19, // 42: standards.open.v1.RT000FTL8.SecurityPricingError.resolution_date:type_name -> google.type.Date
	0,  // 43: standards.open.v1.RT000FTL8.SecurityPricingError.financial_identifier:type_name -> standards.open.v1.RT000FTL8.SecurityPricingError.FinancialInstrumentIdentifier
	1,  // 44: standards.open.v1.RT000FTL8.StaleSecurity.financial_identifier:type_name -> standards.open.v1.RT000FTL8.StaleSecurity.FinancialInstrumentIdentifier
	22, // 45: standards.open.v1.RT000FTL8.StaleSecurity.price_latest:type_name -> google.type.Money
	19, // 46: standards.open.v1.RT000FTL8.StaleSecurity.price_latest_date:type_name -> google.type.Date
	19, // 47: standards.open.v1.RT000FTL8.StockBreak.effective_date:type_name -> google.type.Date
	19, // 48: standards.open.v1.RT000FTL8.StockBreak.identification_date:type_name -> google.type.Date
	19, // 49: standards.open.v1.RT000FTL8.StockBreak.resolution_date:type_name -> google.type.Date
	2,  // 50: standards.open.v1.RT000FTL8.StockBreak.financial_identifier:type_name -> standards.open.v1.RT000FTL8.StockBreak.FinancialInstrumentIdentifier
	19, // 51: standards.open.v1.RT000FTL8.CashBreak.effective_date:type_name -> google.type.Date
	19, // 52: standards.open.v1.RT000FTL8.CashBreak.identification_date:type_name -> google.type.Date
	19, // 53: standards.open.v1.RT000FTL8.CashBreak.resolution_date:type_name -> google.type.Date
	19, // 54: standards.open.v1.RT000FTL8.TotalExpenseRatio.effective_date:type_name -> google.type.Date
	3,  // 55: standards.open.v1.RT000FTL8.TotalExpenseRatio.share_class_id_type:type_name -> standards.open.v1.RT000FTL8.TotalExpenseRatio.ShareClassIdentifierTypes
	19, // 56: standards.open.v1.RT000FTL8.Invoice.invoice_date:type_name -> google.type.Date
	19, // 57: standards.open.v1.RT000FTL8.Invoice.authorisation_date:type_name -> google.type.Date
	19, // 58: standards.open.v1.RT000FTL8.Invoice.payment_date:type_name -> google.type.Date
	22, // 59: standards.open.v1.RT000FTL8.Invoice.invoiced_amount:type_name -> google.type.Money
	22, // 60: standards.open.v1.RT000FTL8.Invoice.fund_specific_amount:type_name -> google.type.Money
	19, // 61: standards.open.v1.RT000FTL8.SwingPricingEvent.effective_date:type_name -> google.type.Date
	22, // 62: standards.open.v1.RT000FTL8.SwingPricingEvent.swing_threshold:type_name -> google.type.Money
	22, // 63: standards.open.v1.RT000FTL8.SwingPricingEvent.nav_without_swing_factor:type_name -> google.type.Money
	22, // 64: standards.open.v1.RT000FTL8.SwingPricingEvent.nav_with_swing_factor:type_name -> google.type.Money
	19, // 65: standards.open.v1.RT000FTL8.PerShareClassNAV.effective_date:type_name -> google.type.Date
	4,  // 66: standards.open.v1.RT000FTL8.PerShareClassNAV.financial_identifier:type_name -> standards.open.v1.RT000FTL8.PerShareClassNAV.FinancialInstrumentIdentifier
	22, // 67: standards.open.v1.RT000FTL8.PerShareClassNAV.nav_per_unit_base_currency:type_name -> google.type.Money
	22, // 68: standards.open.v1.RT000FTL8.PerShareClassNAV.total_nav_base_currency:type_name -> google.type.Money
	22, // 69: standards.open.v1.RT000FTL8.PerShareClassNAV.nav_per_unit_reporting_currency:type_name -> google.type.Money
	22, // 70: standards.open.v1.RT000FTL8.PerShareClassNAV.total_nav_reporting_currency:type_name -> google.type.Money
...
func file_standards_open_v1_RT000FTL8_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_standards_open_v1_RT000FTL8_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RT000FTL8_Metrics); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
