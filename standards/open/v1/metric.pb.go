...
type MonthlyRAGMetric struct {
	...
	AmberCutoff float64 `protobuf:"fixed64,6,opt,name=amber_cutoff,json=amberCutoff,proto3" json:"amber_cutoff,omitempty"`
	// The green cutoff (i.e. the value above which the metric is no longer classified as "AMBER")  if applicable
	GreenCutoff float64 `protobuf:"fixed64,7,opt,name=green_cutoff,json=greenCutoff,proto3" json:"green_cutoff,omitempty"`
...
func (x *MonthlyRAGMetric) GetAmberCutoff() float64 {
	if x != nil {
...
func (x *MonthlyRAGMetric) GetGreenCutoff() float64 {
	if x != nil {
...
var file_standards_open_v1_metric_proto_rawDesc = []byte{
	...
	0x62, 0x65, 0x72, 0x5f, 0x63, 0x75, 0x74, 0x6f, 0x66, 0x66, 0x18, 0x06, 0x20, 0x01, 0x28, 0x01,
